 ...
 */
class Multipleadd extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($data as $item) {
    		...
    		if($productIds !=""){
    			...
    			foreach($pids as $key=>$productId){
    				$params = [];
    				$params['uenc'] = $item['uenc'];
    			    $params['productid'] = $productId;
    			    $params['form_key'] = $item['form_key'];
                    ...
                    if ($promoDataItem) {
                        $qty = 1;//$this->getQtyToAdd($promoDataItem, $params, $productId);
                        $updateTotalQty = true;
                        $requestOptions = array_intersect_key($params, array_flip($this->requestOptions));
    					/* echo '<pre>==pramas==</br>'; print_r($params);
    					echo '==promo==</br>'; print_r($promoDataItem);
    					echo '==request==</br>'; print_r($requestOptions);
    					echo '===='.$qty.'==</br>'; */
    					//die("tttt");
