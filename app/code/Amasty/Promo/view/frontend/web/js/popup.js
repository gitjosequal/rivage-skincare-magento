                ...
                $(this).unbind('mousedown').mousedown(function (e) {
                    ...
                    if (slickStartTransform == slickEndTransform) {
                        ...
                        if (e.target == checkbox[0] ||
                            ...
                            if (self.options.commonQty || $(this).hasClass("-selected")) {
        ...
        reload: function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    widget.isSlickInitialized = false;
                    container.html(response.popup);
                    widget.options.products = response.products;
                    ...
                    if (widget.options.autoOpenPopup) {
                        $('[data-role="ampromo-popup-show"]').click();

                        if (widget.isOpen && container.children().length) {
                            widget.show();
                            widget.isOpen = false;
                            return false;
                        }
