...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($collection as $product) {
            ...
            $priceInclTax = $taxHelper->getTaxPrice($product, $product->getFinalPrice(), true);
            $productList[$i]['price']       = $this->_priceHelper->currency(number_format($priceInclTax,2),true,false);
