...
//         );
        ...
        if(strpos($identifier, 'ingredients/view/index/id') !== false) {
                // called via id 
                return null ;
        }
		else if(strpos($identifier, 'ingredients/') !== false) {
...
// 				var_dump($brand->debug());
				$request->setModuleName('ingredients')->setControllerName('view')->setActionName('index')->setParam('id',$brand->getId());
