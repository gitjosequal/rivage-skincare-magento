    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'megamenu_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_megamenu_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Netbaseteam\Megamenu\Block\Adminhtml\Form\Element\Image'];
    }
}
