    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Netbaseteam\MegamenuModel\Megamenu */
        ...
        $form->setHtmlIdPrefix('megamenu_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_megamenu_edit_tab_content_prepare_form', ['form' => $form]);
