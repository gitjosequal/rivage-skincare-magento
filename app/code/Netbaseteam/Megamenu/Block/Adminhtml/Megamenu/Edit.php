...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Netbaseteam_Megamenu';
        ...
        if ($this->_isAllowedAction('Netbaseteam_Megamenu::megamenu_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('megamenu')->getId()) {
            return __("Edit Megamenu '%1'", $this->escapeHtml($this->_coreRegistry->registry('megamenu')->getCategoryId()));
        } else {
