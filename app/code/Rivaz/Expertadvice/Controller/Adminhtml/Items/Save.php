...
class Save extends \Rivaz\Expertadvice\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('rivaz_expertadvice/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('rivaz_expertadvice/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('rivaz_expertadvice/*/new');
                }
                return;
            } catch (\Exception $e) {
