...
define([
    ...
    return function (config) {
        var optionDefaultInputType = 'radio',
            attributeOption = {
                ...
                add: function (data, render) {
                    ...
                    // @important: fix for Magento_Catalog/js/options - the following code does not take options (((
                    if (!data.intype) {
                        var inpyte = optionDefaultInputType;
                        if ($('frontend_input') && window.inputTypes.hasOwnProperty($('frontend_input').value)) {
                            inpyte = window.inputTypes[$('frontend_input').value];
                        }
                        data.intype = inpyte;
                    }
                ...
                render: function () {
                    ...
                    this.elements = '';
                    if (typeof window.updateOptionTemplate !== 'undefined') {
                        window.updateOptionTemplate();
                    }
                },
        ...
        if ($('add_new_swatch_visual_option_button')) {
            Event.observe('add_new_swatch_visual_option_button', 'click', attributeOption.add.bind(attributeOption, {}, true));
        }
