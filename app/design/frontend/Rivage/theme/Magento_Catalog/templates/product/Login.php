...
class Login extends Action
{
    ...
    public function execute()
    {
        ...
        if (!$customer->getId()) {
            ...
            //$prefix = ($userProfile->gender == 'male') ? 'Mr.' : 'Mrs.';
			
			$prefix = '';
			 $storid =  $this->storeManager->getStore()->getStoreId();
	    ...
	    if($userProfile->gender == 'female'){
            ...
            if($userProfile->birthDay != null &&  $userProfile->birthMonth != null &&  $userProfile->birthYear != null) {
                if($userProfile->birthDay != '0' &&  $userProfile->birthMonth != '0' &&  $userProfile->birthYear != '0')
                    $dob =  $userProfile->birthDay+ "/" + $userProfile->birthMonth + "/" + $userProfile->birthYear;
            }
            else $dob = '01/01/1970';
            $user = array_merge([
