    ...
    function (
        ...
        return ccFormComponent.extend({
            defaults: {
                ...
                adapterLoaded: false,
                buttonTitle: null,
                buttonTitleEnabled: $t('تأكيد الطلب'),
                buttonTitleDisabled: $t('الرجاء الانتظار...'),
                imports: {
            ...
            getCcMonths: function() {
                return {1: '01 - January', 2: '02 - February', 3: '03 - March', 4: '04 - April', 5: '05 - May', 6: '06 - June', 7: '07 - July', 8: '08 - August', 9: '09 - September', 10: '10 - October', 11: '11 - November', 
                12: '12 - December'};
                return window.checkoutConfig.payment.ccform.months[this.getCode()];
            },

            getCcYears: function() {
                Object.keys(window.checkoutConfig.payment.ccform.years['tns_hpf']).forEach(function(key) {
                    window.checkoutConfig.payment.ccform.years['tns_hpf'][key] = parseInt(key);
                });
                return window.checkoutConfig.payment.ccform.years[this.getCode()];
            },

            getCvvImageUrl: function() {
                var cvv_img = 'https://rivagecare.com/pub/static/version1639159025/frontend/Rivage/arabictheme/ar_SA/Magento_Checkout/cvv.png';
                return cvv_img;
            },
            ...
            errorMap: function () {
                return {
                    'cardNumber': $t('رقم البطاقة خاطئ'),
                    'securityCode': $t('رمز الحماية خاطئ'),
                    'expiryMonth': $t('شهر الانتهاء خاطئ'),
                    'expiryYear': $t('سنة الانتهاء خاطئة')
                };
            },
