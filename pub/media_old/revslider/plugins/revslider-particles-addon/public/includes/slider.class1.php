...
class RsParticlesSliderFront extends RevSliderFunctions {
	...
	public function __construct(
		...
		if(!$isAdmin) $this->_frameworkHelper->add_action('revslider_slide_initByData', array($this, 'check_addon_active'), 10, 1);
	...
	public function check_addon_active($record) {
		...
		$this->add_scripts();
		$this->_frameworkHelper->remove_action('revslider_slide_initByData', array($this, 'check_addon_active'), 10);
